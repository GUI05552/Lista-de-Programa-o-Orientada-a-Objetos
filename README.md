# Lista de Exercícios II — Programação Orientada a Objetos em Python

Este repositório contém a implementação da Lista de Exercícios II da disciplina de Programação Orientada a Objetos utilizando Python.

Os exercícios foram desenvolvidos com foco nos principais conceitos de POO, incluindo:
...
```bash
git clone https://github.com/seuusuario/lista-exercicios-python.git
